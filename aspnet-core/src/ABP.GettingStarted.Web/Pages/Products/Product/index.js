$(function () {
    ...
    var l = abp.localization.getResource('GettingStarted');

    var service = aBP.gettingStarted.products.product;
                ...
                rowAction: {
                    items:
                        [
                            {
                                text: l('Edit'),
                                visible: abp.auth.isGranted('GettingStarted.Product.Update'),
                            ...
                            {
                                text: l('Delete'),
                                visible: abp.auth.isGranted('GettingStarted.Product.Delete'),
